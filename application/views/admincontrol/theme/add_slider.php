	...
	<div class="col-12">
		<div class="card m-b-30">
			<div class="card-header">
				<h4 class="card-title pull-left">Add Slider</h4>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input placeholder="Description" name="description" class="form-control" value="<?php echo $slider->description; ?>" type="text">
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
