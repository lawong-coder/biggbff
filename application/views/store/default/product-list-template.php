<script id="product-list-template" type="text/html">
	...
	<div class="product-wrapper">
		<div class="product-img position-relative mb-2">
			<a href="{{product_details_href}}"><img alt="image" src="{{product_image_src}}" class="img-fluid primg" onerror="this.src='<?= base_url('assets/store/default/img/no-image.png')?>';"/></a>
			{{#country_code}}
			<div class="cn-flag position-absolute">
				<img alt="image" src="{{country_flag_src}}" /> {{country_name}}, {{state_name}}</span>
			</div>
			{{/country_code}}
		</div>
		...
		<div class="product-buttons d-flex">
			<a href="{{product_details_href}}" class="btn btn-product bg-main2 text-white">Details</a>
		</div>
	</div>
	{{/products}}
</script>