...
<!-- Start: footer -->
<footer class="footer mobile-footer common-side-footer">
	<div class="top-footer">
		<div class="container-fluid">
			<div class="row">
				<div class="col-12">
					<span class="common-footer-text">Made with </span><i class="mdi mdi-heart text-danger"></i><span class="common-footer-text"> By Bigg Innovate</span>
				</div>
			</div>
		</div>
	</div>
