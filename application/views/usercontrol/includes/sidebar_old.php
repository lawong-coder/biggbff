 ...
 <!-- ========== Left Sidebar Start ========== -->
        ...
        <center><img style="max-width: 125px;margin-top:10px;" src="<?= $logo ?>" id="logo" class="img-fluid"></center>
			...
			<ul>
			    ...
			    <!-- <li><a href="<?php echo base_url();?>usercontrol/franchise_plan/"><i class="mdi mdi-archive"></i><?= __('user.franchise_plan') ?></a></li> -->
				
				<li><a href="<?php echo base_url();?>usercontrol/store_markettools/"><i class="mdi mdi-archive"></i><?= __('user.my_links') ?></a></li>
