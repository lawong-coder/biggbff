    ...
    <div class="topbar-left">
        <div class="logo-container">
            <?php 
                ...
                $logo_text = ($setting['top_left_text']) ? $setting['top_left_text'] : __('admin.menu_admin_panel_title');
            ?>
            <a href="<?php echo base_url(); ?>admincontrol/dashboard" class="logo text-center">
                ...
                <a class="nav-link dropdown-toggle arrow-none waves-effect nav-user" data-toggle="dropdown" href="#" role="button"
                   aria-haspopup="false" aria-expanded="false">
                    ...
                    <?php 
                        ...
                        $login_user_profile_avatar =  (!empty($userdetails['avatar'])) ? base_url('assets/images/users/'.$userdetails['avatar']) : base_url('assets/vertical/assets/images/users/default_avatar.jpg');

                    ?>
                        <img class="rounded-circle" src="<?= $login_user_profile_avatar; ?>" alt="admin" width="65px">
                </a>
