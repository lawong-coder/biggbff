...
<?php 
  ...
  if ($MembershipSetting['status']) {
    ...
    if((int)$user->plan_id == 0){
      ...
      } else if(($plan->isExpire() || !$plan->strToTimeRemains() > 0) && !$plan->is_lifetime){

        if (!isset($notcheckmember)) {

          redirect('usercontrol/purchase_plan_expire');die;
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('/assets/vertical/assets/plugins/slick-slider/slick.css') ?>">
    <link rel="stylesheet" type="text/css" href="<?= base_url('/assets/vertical/assets/plugins/slick-slider/slick-theme.css') ?>">
    <link rel="stylesheet" type="text/css" href="<?= base_url('/assets/vertical/assets/css/hierarchical_organization_chart.css'); ?>">
    <link href="<?php echo base_url(); ?>assets/vertical/assets/css/custom.css?v=<?= av() ?>" rel="stylesheet" type="text/css">
...
<body class="fixed-left userview">
