                    		...
                    		<tbody>
                    			...
                    			<?php foreach ($plans as $key => $plan) { ?>
                    				<tr>
                                        ...
                                        <td><?= ($plan->user ? $plan->user->firstname : '') ?></td>
                                        <td><?= ($plan->user ? $plan->user->lastname : '') ?></td>
                                        ...
                                        <td><?= (($plan->user->refid != 1) && $plan->user->reffered_by) ? $plan->user->reffered_by->username : '-' ?></td>
                    					<td>
                    						<a href="<?= base_url('membership/membership_purchase_edit/'. $plan->id) ?>" class="btn btn-sm btn-primary">View</a>
                                            <!-- <?php if($plan->is_active == 0){ ?>
