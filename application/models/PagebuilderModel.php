...
class PagebuilderModel extends MY_Model{
	...
	public function web_activate_view($file_name, $data = array(), $control = 'usercontrol/activate_user'){
		$data['design'] = '';
		$data['theme_pages'] = $this->theme->getPages();
		$data['theme_links'] = $this->theme->get_links(true);
		...
		$this->load->view($control . '/header', $data);
		$this->load->view($file_name, $data);
		$this->load->view($control . '/footer', $data);
	}
