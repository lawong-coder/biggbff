...
<!--Hero-->
<div class="wlc-hero-area inner-hero-area d-flex align-items-center" style="background-image: url(<?= base_url('assets/login/multiple_pages') ?>/img/inner-hero-bg.jpg)">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="wlc-hero-content text-center">
                        <h1><?= (!empty($page_data->top_banner_title)) ? $page_data->top_banner_title : "Internal Page" ?></h1>
                    </div>
                </div>
            </div>
        </div>
