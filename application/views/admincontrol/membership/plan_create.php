                ...
                <div class="col-sm-12">
                    <div class="card m-b-30">
                        <div class="card-header">
                            <h4 class="header-title pull-left m-0">Create Plan</h4>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label class="form-control-label">FEGO Shares</label>
                                <input type="text" name="fego_shares" class="form-control only-number-allow" ng-model='plan.fego_shares'>
                            </div>

                            <div class="form-group">
                                <label class="form-control-label">Bigg Coupon</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="products-list">
                                    <div class="row new-product" style="padding-bottom: 10px;">
                                        <div class="col">
                                            <input type="text" name="product[0][name]" ng-model='membership_plan_products.name' class="form-control product_name" placeholder="Enter Name">
                                        </div>
                                        <div class="col">
                                            <input type="text" name="product[0][quantity]" ng-model='membership_plan_products.quantity' class="form-control only-number-allow product_quantity" placeholder="Enter quantity">
                                        </div>
                                    </div>
                                    <?php
                                        $element_counter++;
