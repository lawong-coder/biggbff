...
.reload-btn{
 ...
 <!-- ========== Left Sidebar Start ========== -->
            <div class="left side-menu usercontrol-menu" id="user_side_menu">
        ...
        <!-- <center><img style="max-width: 125px;margin-top:10px;" src="<?= $logo ?>" id="logo" class="img-fluid"></center> -->
			...
			<ul>
				<li>
					<a href="<? echo base_url('usercontrol/transaction_history/') ?>"><i class="mdi mdi-wallet"></i><?= __('user.page_title_e_wallet_transaction') ?></a>
				</li>
				<li>
					<a href="<?php echo base_url('usercontrol/withdraw_requests/');?>"><i class="mdi mdi-archive"></i><?= __('user.page_title_withdrawal_request') ?></a>
				</li>
				<li>
					<a href="<?php echo base_url('usercontrol/transfer_requests/');?>"><i class="mdi mdi-trending-up"></i><?= __('user.page_title_transfer_request') ?></a>
				</li>
				<li>
					<a href="<?php echo base_url('/usercontrol/referral_history'); ?>" class="waves-effect"><i class="mdi mdi-link-variant-off"></i><span> <?= __('user.page_title_referrals_history') ?></span></a>
				</li>
				<li>
					<a href="<?php echo base_url('/usercontrol/purchase_history/'); ?>" class="waves-effect"><i class="mdi mdi-history"></i><span> <?= __('user.page_title_franchise_history') ?></span></a>
				</li>
				...
				<!-- <li class="has_sub">
					...
					<ul class="list-unstyled">
	     				<li><a href="<?php echo base_url('usercontrol/mywallet/');?>"><?= __('user.my_transactions') ?></a></li>
				...
				<?php /* if(($membership['status'] == 1) || (($membership['status'] == 2) && ($userdetails['is_vendor'] == 1)) || (($membership['status'] == 3) && ($userdetails['is_vendor'] == 0))){ ?>
					<li class="has_sub">
						...
						<ul class="list-unstyled">
		     				<li><a href="<?php echo base_url('usercontrol/purchase_plan/');?>"><?= __('user.page_title_buy_membership') ?></a></li>
		     				<li><a href="<?php echo base_url('usercontrol/purchase_history/');?>"><?= __('user.page_title_purchase_history') ?></a></li>
						</ul>
					</li>
				<?php } */ ?>
            ...
            <div class="content-page">
                ...
                <div class="content">
                    <!-- ==================
                         PAGE CONTENT START
                         ================== -->
                    <div class="page-content-wrapper d-none d-md-block">
