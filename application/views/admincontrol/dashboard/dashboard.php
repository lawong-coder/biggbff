    ...
    <!-- <div class="col-xl-2 d-flex align-items-center mb-2 mb-lg-0">
        <div class="card border shadow-sm counter-card">
            <div class="card-body p-4 text-center">
                <ul class="list-inline mb-0 clearfix w-100">
                    <li class="col-12">
                        <p class="mb-0 text-secondary">Admin Balance</p>
                        <p class="m-b-5 font-18 font-500 counter ajax-admin_balance"><?= c_format($admin_totals['admin_balance']) ?></p>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="card-body p-4 text-center">
                <ul class="list-inline mb-0 clearfix w-100">
                    <li class="col-12">
                        ...
                        <p class="m-b-5 font-18 font-500 counter ajax-admin_total_sale"><?= c_format($admin_totals['admin_total_sale']) ?></p>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="card-body p-4 text-center">
                <ul class="list-inline mb-0 clearfix w-100">
                    <li class="col-12">
                        ...
                        <p class="m-b-5 font-18 font-500 counter ajax-total_members"><?= $admin_totals['total_members'] ?></p>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="col-xl-2 d-flex align-items-center mb-2 mb-lg-0">
        <div class="card border shadow-sm counter-card">
            <div class="card-body p-4 text-center">
                <ul class="list-inline mb-0 clearfix w-100">
                    <li class="col-12">
                        <p class="mb-0 text-secondary">Total Commission</p>
                        <p class="m-b-5 font-18 font-500 counter ajax-admin_total_commission"><?= c_format($admin_totals['admin_total_commission']) ?></p>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="card-body p-4 text-center">
                <ul class="list-inline mb-0 clearfix w-100">
                    <li class="col-12">
                        ...
                        <p class="m-b-5 font-18 font-500 counter ajax-admin_total_withdrawal"><?= c_format($admin_totals['admin_total_withdrawal']) ?></p>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="col-xl-2 d-flex align-items-center mb-2 mb-lg-0">
        <div class="card border shadow-sm counter-card">
            <div class="card-body p-4 text-center">
                <ul class="list-inline mb-0 clearfix w-100">
                    <li class="col-12">
                        <p class="mb-0 text-secondary">Total Transfer</p>
                        <p class="m-b-5 font-18 font-500 counter ajax-admin_total_transfer"><?= c_format($admin_totals['admin_total_transfer']) ?></p>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="col-xl-2 d-flex align-items-center mb-2 mb-lg-0">
        <div class="card border shadow-sm counter-card">
            <div class="card-body p-4 text-center">
                <ul class="list-inline mb-0 clearfix w-100">
                    <li class="col-12">
                        <p class="mb-0 text-secondary">Total Franchise</p>
                        <p class="m-b-5 font-18 font-500 counter ajax-admin_total_franchise"><?= $admin_totals['admin_total_franchise'] ?></p>
                    </li>
                </ul>
            </div>
        </div>
...
<div class="row">
    <div class="col-xl-7">
        <div class="new-card shadow-sm">
            <div class="card-header border-0">
                <h5 class="card-title"><?php echo __('admin.admin_members_trend') ?></h5>
                            ...
                            datasets: [
                                {
                                    ...
                                    backgroundColor: g,
                                    borderColor: "#1dc9b7",
                                    data: Object.values(chartData['total_members']),
                                }
                            ]
                        }
        ...
        <div class="new-card shadow-sm">
            <div class="card-header border-0">
                <h5 class="card-title"><?php echo __('admin.admin_sales_trend') ?></h5>
                <div class="card-options">
                    <select onchange="loadDashboardSalesChart()" class="renderSalesChart sales-chart-input form-control mr-1" name="group">
                        <option value="day" ><?= __('admin.day') ?></option>
                        <option value="week"><?= __('admin.week') ?></option>
                        <option value="month" selected=""><?= __('admin.month') ?></option>
                        <option value="year"><?= __('admin.year') ?></option>
                    ...
                    <select onchange="loadDashboardSalesChart()" class="salesYearSelection sales-chart-input form-control" name='year'>
                        <?php for($i=2016; $i<= date("Y"); $i++){ ?>
                            <option value="<?= $i ?>" <?php echo $i==date("Y") ? "selected='selected'" : '' ?>><?= $i ?></option>
                        <?php  } ?>
                    </select>
            ...
            <div class="card-body">
                <canvas height="340px" id="dashboard-sales-chart" class="ct-chart ct-golden-section"></canvas>
                <div id="dashboard-sales-chart-empty" class="ct-chart d-none ct-golden-section">
                    <div class="text-center">
                        <img class="img-responsive" src="<?php echo base_url(); ?>assets/vertical/assets/images/no-data-2.png" style="margin-top:10px;">
                        <h3 class="m-t-40 text-center"><?= __('admin.not_activity_yet') ?></h3>
                    </div>
                ...
                <script type="text/javascript">
                    var ctx1 = document.getElementById('dashboard-sales-chart').getContext('2d');
                    var chartData = <?= json_encode($sales_chart) ?>;

                    var sales_chart = new Chart(ctx1, {
                        type: 'bar',
                        data: {},
                        options: {
                            showLines: true,
                    ...
                    function renderDashboardSalesChart(chartData){
                        console.log(chartData);
                        var t = ctx1.createLinearGradient(0, 0, 0, 150);
                        t.addColorStop(0, Chart.helpers.color("#fd397a").alpha(.3).rgbString());
                        t.addColorStop(1, Chart.helpers.color("#fd397a").alpha(0).rgbString());

                        var g = ctx1.createLinearGradient(0, 0, 0, 150);
                        g.addColorStop(0, Chart.helpers.color("#1dc9b7").alpha(.3).rgbString());
                        g.addColorStop(1, Chart.helpers.color("#1dc9b7").alpha(0).rgbString());
                            ...
                            datasets: [
                                {
                                    ...
                                    backgroundColor: g,
                                    borderColor: "#1dc9b7",
                                    data: Object.values(chartData['total_sale']),
                                }
                            ]
                        }
                    ...
                    function loadDashboardSalesChart(){
                        $.ajax({
                            url:'<?= base_url("admincontrol/dashboard?getSalesChartData=1") ?>',
                            type:'POST',
                            dataType:'json',
                            data:$(".sales-chart-input"),
                            beforeSend:function(){},
                            complete:function(){},
                            success:function(json){
                               renderDashboardSalesChart(json['sales_chart']);
                            },
                        })
                    }
    ...
    <div class="col-xl-5">
        ...
        ?>
            <div class="profile__picture"><img src="<?= $login_user_profile_avatar; ?>" alt=""/></div>
        ...
        <div class="new-card">
            <div class="card-header border-0">
                <h5 class="card-title"><?= __('admin.top_referers') ?></h5>
            </div>
            <div class="card-body p-0">
                            ...
                            <tbody>
                                <?php foreach ($populer_users as $key => $users) { ?>
                                    <tr>
                                        ...
                                        <td><?= isset($users['total_referrals']) ? $users['total_referrals'] : 0; ?></td>
        ...
        <div class="new-card">
            <div class="card-header border-0">
                <h5 class="card-title"><?= __('admin.recent_members') ?></h5>
            </div>
            <div class="card-body p-0">
                <div role="tabpanel" id="recent-users-data">
                    <div class="data-here">
                        <table class="table-striped table responsive no-wrap">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($recent_users as $key => $user) { ?>
                                    <tr>
                                        ...
                                        <td><?= isset($user->default_plan->name) ? $user->default_plan->name : '' ?></td>
                                        <td><?= (!empty($user->refid) && ($user->refid != 1) && isset($user->reffered_by->firstname)) ? $user->reffered_by->firstname . ' ' . $user->reffered_by->lastname : '' ?></td>
                                    </tr>
                                    <?php $recent_count++ ?>
                                <?php } ?>
                            </tbody>
                    ...
                    <script type="text/javascript">
                        var dataTableUser = $("#recent-users-data table").dataTable({
                            "paging":   false,
                            "ordering": false,
                            "searching": false,
                            "info":     false
...
<script type="text/javascript">
    ...
    var checkdata = {
        ...
        '.ajax-admin_total_sale'                  : 'admin_total_sale',
        '.ajax-total_members'                     : 'total_members',
        '.ajax-admin_total_commission'            : 'admin_total_commission',
        '.ajax-admin_total_withdrawal'            : 'admin_total_withdrawal',
        '.ajax-admin_total_transfer'              : 'admin_total_transfer',
    ...
    function getDashboard(callnexttime,show_popup,actions){
        ...
        dashboard_xhr = $.ajax({
            ...
            data:{
                ...
                renderSalesChart  : $(".renderSalesChart").val(),
                selectedsalesyear: $('.salesYearSelection').val(),
