...
$pageSetting['membership_membership_payment_gateways'] = array(
	'title' => __('admin.page_title_membership_payment_gateways'),
	'breadcrumb' => array(
		array(
			'title' =>  __('admin.page_title_dashboard'),
			'link' =>  base_url('admincontrol/dashboard'),
		...
		array(
			'title' =>  __('admin.page_title_membership_payment_gateways'),
			'link' =>  base_url('membership/membership_payment_gateways'),
		),
	),
);
...
$pageSetting['membership_membership_payment_gateways_edit'] = array(
	'title' => __('admin.page_title_membership_payment_gateways_edit'),
	'breadcrumb' => array(
		array(
			'title' =>  __('admin.page_title_dashboard'),
			'link' =>  base_url('admincontrol/dashboard'),
...
$pageSetting['admincontrol_userslist'] = array(
	'title' => __('admin.page_title_franchiseusers'),
	'breadcrumb' => array(
		array(
			'title' =>  __('admin.page_title_dashboard'),
			'link' =>  base_url('admincontrol/dashboard'),
...
$pageSetting['admincontrol_belts'] = array(
	'title' => __('admin.belts'),
	'breadcrumb' => array(
		array(
			'title' =>  __('admin.page_title_dashboard'),
			'link' =>  base_url('admincontrol/dashboard'),
		...
		array(
			'title' =>  __('admin.belts'),
			'link' =>  base_url('admincontrol/belts'),
		),
	),
);

$pageSetting['admincontrol_belt'] = array(
	'title' => __('admin.menu_belt_details'),
	'breadcrumb' => array(
		array(
			'title' =>  __('admin.page_title_dashboard'),
			'link' =>  base_url('admincontrol/dashboard'),
...
$pageSetting['admincontrol_commission_paid'] = array(
	'title' => __('admin.commission_paid_page'),
	'breadcrumb' => array(
		array(
			'title' =>  __('admin.page_title_dashboard'),
			'link' =>  base_url('admincontrol/dashboard'),
		...
		array(
			'title' =>  __('admin.commission_paid_page'),
			'link' =>  base_url('admincontrol/commission_paid'),
		),
	),
);
...
$pageSetting['admincontrol_editProfile'] = array(
	'title' => __('admin.page_title_profile'),
	'breadcrumb' => array(
		array(
			'title' =>  __('admin.page_title_dashboard'),
			'link' =>  base_url('admincontrol/dashboard'),
...
$pageSetting['usercontrol_purchase_history'] = array(
	'title' => __('user.page_title_franchise_history'),
	/*'breadcrumb' => array(
		array(
			'title' =>  __('user.page_title_dashboard'),
			'link' =>  base_url('usercontrol/dashboard'),
...
$pageSetting['usercontrol_membership_purchase_details'] = array(
	'title' => __('user.page_title_membership_transaction_details'),
	/*'breadcrumb' => array(
		array(
			'title' =>  __('user.page_title_dashboard'),
			'link' =>  base_url('usercontrol/dashboard'),
